...
export function MilestoneTimeline({
  ...
  const handleConfirmDelete = () => {
    if (milestoneToDelete && onDeleteMilestone) {
      onDeleteMilestone(milestoneToDelete);
    }
    ...
    <>
      <div className="space-y-6">
        {milestones.map((milestone, index) => {
          ...
          const taskStats = milestone.taskStats || { total: 0, completed: 0 };
                ...
                <div className="p-5">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 space-y-3">
                      ...
                      {/* Progress Bar - Agora baseado em tarefas */}
                      {!isCompleted && (
                        <div className="space-y-2">
                          <div className="flex items-center justify-between text-sm">
                            <span className="text-muted-foreground">
                              {taskStats.total > 0 
                                ? `Progresso (${taskStats.completed} de ${taskStats.total} tarefas concluídas)`
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Esta ação não pode ser desfeita. O milestone será removido permanentemente.
              Tarefas vinculadas a este milestone serão desassociadas, mas não excluídas.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
