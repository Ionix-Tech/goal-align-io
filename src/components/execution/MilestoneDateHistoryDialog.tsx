...
interface MilestoneDateHistoryDialogProps {
...
export function MilestoneDateHistoryDialog({
  milestoneId,
  milestoneTitle,
  open,
  onOpenChange
}: MilestoneDateHistoryDialogProps) {
  const { data: history, isLoading } = useMilestoneDateHistory(milestoneId);
      ...
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Histórico de Datas - {milestoneTitle}
          </DialogTitle>
        </DialogHeader>
